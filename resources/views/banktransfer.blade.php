    ...
    <main class="content-area p-3">
      ...
      <div class="accordion" id="paymentAccordion">
        ...
        <div class="accordion-item payment-card">
          ...
          <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#paymentAccordion">
            <div class="accordion-body">
              Opsi kartu debit akan muncul di sini.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item payment-card">
          ...
          <div id="collapseTwo" class="accordion-collapse collapse show" data-bs-parent="#paymentAccordion">
            <div class="accordion-body p-0">
              <ul class="bank-list">
                <li>
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Bank_Central_Asia_logo.svg/2560px-Bank_Central_Asia_logo.svg.png" alt="BCA" class="bank-logo">
                  Bank BCA
                </li>
                <li>Bank BNI</li>
                <li>Bank BRI</li>
        ...
        <div class="accordion-item payment-card">
          ...
          <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#paymentAccordion">
            <div class="accordion-body">
              Opsi E-wallet akan muncul di sini.
            </div>
          </div>
        </div>
      </div>
