...
<head>
    ...
    <title>Coin Top Up - Alfamart Payment - MystiCake</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/topup/topUpCoinAlfamart3.css') }}">
</head>
<body>

    <!-- Header -->
    <div class="header-container">
        <a href="{{ route('topup.alfamart.page') }}" class="back-button">
    ...
    <div class="content-container">
        ...
        <!-- Alfamart Payment Card -->
        <div class="payment-card">
            <div class="store-header">
                <img src="{{ asset('images/topup/alfamart.png') }}" alt="Alfamart" class="store-logo">
                <span class="store-name">Alfamart</span>
            </div>
        ...
        <div class="info-container">
            ...
            <span class="info-text">Inform the Alfamart cashier that you're making payment coin top up MYstiCake and show the barcode payment and make your payment.</span>
        </div>
