...
<head>
    ...
    <title>Coin Top Up - Alfamart - MystiCake</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/topup/topUpCoinAlfamart12.css') }}">
</head>
<body>
    ...
    <div class="floating-bar">
        <img src="{{ asset('images/topup/alfamart.png') }}" alt="Alfamart" class="floating-bar-logo">
        <span class="floating-bar-text">Alfamart Payment Method</span>
    </div>
    ...
    <!-- Pay Now Button -->
    <form id="paymentForm" action="{{ route('topup.alfamart.process.payment') }}" method="POST">
        @csrf
